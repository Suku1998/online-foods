...
<body>
    ...
    <div class="">
                 <h3 class="">User Order Details</h3>
             </div>
            ...
            <div class="col_lg-12 col-12">
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th class="py-3 text=white"> O Id </th>
...
{
      $order=$_POST['order_user'];
      $query="DELETE FROM orders_users WHERE o_id='$order'";
...
$selectquery="select * from orders_users";
        ...
        <tr>
            ...
            <td>
                <form action="displayorder.php" method="POST">
                    <button type="submit" name="order_user"  class="btn btn-dark" value="<?php echo $result['o_id']?>">Delete</button>
                </form>
            </td>
        </tr>
        <?php
